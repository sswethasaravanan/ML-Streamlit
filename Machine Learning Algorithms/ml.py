...
#Main Function
st.set_page_config(
     page_title='Machine-Learning-Algorithm',
     page_icon='logo.jpg',
     layout="wide",
...
#Sidebar Start
def cs_sidebar():
    st.sidebar.markdown('''[<img src='data:image/png;base64,{}' class='img-fluid' width=300 height=170>](https://numpy.org/doc/stable/user/whatisnumpy.html)'''.format(img_to_bytes("ml.png")), unsafe_allow_html=True)
    ...
    st.sidebar.markdown("We having Certain Machine Learning Algorithms to built an Artificial Intelligence Model training and implementation in various sectors")
    st.sidebar.title("Algorithms List")
    st.sidebar.header("* Supervised Learning")
    st.sidebar.subheader("* Regression")
    st.sidebar.subheader("* Classifiation")
    st.sidebar.header("* Unsupervised Learning")
    st.sidebar.subheader("* Clustering")
    st.sidebar.subheader("* Dimensionality Reduction")
    st.sidebar.header("* Reinforcement Learning")
